    ...
    public static class Language {
        ...
        public static Dictionary<string, Dictionary<string, string>> Languages = new Dictionary<string, Dictionary<string, string>> {
            ...
            { "Русский",  new Dictionary<string, string> {
                ...
                { "warn_DeleteExistingBittersmile", "Вы должны удалить существущий бэкап bittersmile из вашей директории QCMA directory. Если вы хотите ее оставить, то просто переместите. Удалить?" },
